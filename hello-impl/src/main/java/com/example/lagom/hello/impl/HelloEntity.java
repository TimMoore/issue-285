...
import akka.Done;
import com.example.lagom.hello.impl.HelloCommand.Hello;
import com.example.lagom.hello.impl.HelloCommand.UseGreetingMessage;
import com.example.lagom.hello.impl.HelloEvent.GreetingMessageChanged;
...
public class HelloEntity extends PersistentEntity<HelloCommand, HelloEvent, HelloState> {
  ...
  public Behavior initialBehavior(Optional<HelloState> snapshotState) {
    ...
    b.setReadOnlyCommandHandler(Hello.class,
        ...
        (cmd, ctx) -> ctx.reply(GreetingMessage.of(state().message + ", " + cmd.name + "!")));
