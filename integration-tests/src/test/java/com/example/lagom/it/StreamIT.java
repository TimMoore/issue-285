...
public class StreamIT {
    ...
    public void helloWorld() throws Exception {
        GreetingMessage answer = await(helloService.hello("foo").invoke());
        assertEquals(GreetingMessage.of("Hello, foo!"), answer);
        await(helloService.useGreeting("bar").invoke(GreetingMessage.of("Hi")));
        GreetingMessage answer2 = await(helloService.hello("bar").invoke());
        assertEquals(GreetingMessage.of("Hi, bar!"), answer2);
    }
